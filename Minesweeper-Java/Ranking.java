...
public class Ranking {
    ...
    /**
     * Makes two arrays for storing names and scores.
     */
    Ranking() {
    ...
    /**
     * Takes a name as input and stores it in the ranking list.
     * @param result
     */
    ...
    /**
     * Writes the ranking list to the screen.
     */
    public void show() {
        if (last == 0) {
